...
local function make_server_ready(attach)
	lsp_installer.on_server_ready(function(server)
		...
		if server.name == "sumneko_lua" then
			...
			opts.settings = require("lsp.lua-lspsettings").lua.settings
		end
		...
		if server.name == "clangd" then
            ...
            opts.cmd = require("lsp.cpp-lspsettings").clangdSetting.cmd
            opts.filetypes = require("lsp.cpp-lspsettings").clangdSetting.filetypes
...
-- setup the LS
local On_attach = require("plugins/nvim-lsp-config").On_attach
